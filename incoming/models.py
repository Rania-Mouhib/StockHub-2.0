...
class Article(models.Model):
    type = models.ForeignKey(Type, on_delete=models.CASCADE, related_name='incoming_articles')
    model = models.ForeignKey(Model, on_delete=models.CASCADE, related_name='incoming_articles')
